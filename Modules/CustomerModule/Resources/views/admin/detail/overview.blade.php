                    ...
                    <div class="">
                        ...
                        <div class="information-details-box media flex-column flex-sm-row gap-20 mb-3">
                            <img class="avatar-img radius-5"
                                    ...
                                    onerror="this.src='{{asset('assets/admin-module')}}/img/media/info-details.png'"
                                    alt="">
                                    
                                    <!-- @if($customer->document)
                                    <img class="avatar-img radius-5"
                                    src="{{asset('storage/app/public/user/document')}}/{{$customer->document}}"
                                    alt="">
                                    @else
                                    ...
                                    @if($customer->document)
                                    <a class="btn btn-warning" target="_blank" href="{{asset('storage/app/public/user/document')}}/{{$customer->document}}">View Document</a>
                                    @else
                                    <span>No document found</span>
                                    @endif
                        ...
                        <!-- Customer Address -->
                        <div class="information-details-box customer-address d-none">
