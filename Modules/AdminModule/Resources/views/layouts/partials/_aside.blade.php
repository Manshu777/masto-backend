    ...
    <div class="aside-body" data-trigger="scrollbar">
        ...
        <ul class="nav">
            ...
            @if(access_checker('customer_management'))
                ...
                <!-- Customer Wallet -->
                <li class="has-sub-item {{request()->is('admin/customer/wallet*')?'sub-menu-opened':''}} d-none">
                ...
                <!-- Customer Wallet -->
                <li class="has-sub-item {{request()->is('admin/customer/loyalty-point*')?'sub-menu-opened':''}} d-none">
            ...
            @if(access_checker('provider_management'))
                ...
                <li class="has-sub-item d-none  {{(request()->is('admin/provider/list') || request()->is('admin/provider/create') || request()->is('admin/provider/details*') || request()->is('admin/provider/edit*') || request()->is('admin/provider/collect-cash*'))?'sub-menu-opened':''}}">
            ...
            @if(access_checker('promotion_management'))
                <li class="nav-category d-none" title="{{translate('promotion_management')}}">
                    {{translate('promotion_management')}}
                </li>
                <li class="has-sub-item {{request()->is('admin/discount/*')?'sub-menu-opened':''}} d-none">
                ...
                <li class="has-sub-item {{request()->is('admin/coupon/*')?'sub-menu-opened':''}} d-none">
                ...
                <li class="has-sub-item {{request()->is('admin/campaign/*')?'sub-menu-opened':''}} d-none">
            ...
            @if(access_checker('booking_management'))
                ...
                <li class="has-sub-item {{request()->is('admin/booking/*')?'sub-menu-opened':''}}">
                    ...
                    <ul class="nav sub-menu">
                        ...
                        <li class="d-none"><a href="{{route('admin.booking.list', ['booking_status'=>'pending'])}}"
                        ...
                        <li><a href="{{route('admin.booking.list', ['booking_status'=>'accepted'])}}"
                               class="{{request()->is('admin/booking/list') && request()->query('booking_status')=='accepted'?'active-menu':''}}"><span
                                    class="link-title"><!-- {{translate('Accepted')}} --> Upcoming Bookings <span
                                        class="count">{{$booking->where('booking_status', 'accepted')->count()}}</span></span></a>
                        </li>
                        <li class="d-none"><a href="{{route('admin.booking.list', ['booking_status'=>'ongoing'])}}"
                        ...
                        <li class="d-none"><a href="{{route('admin.booking.list', ['booking_status'=>'canceled'])}}"
            ...
            @if(access_checker('system_management'))
                ...
                <li class="has-sub-item {{request()->is('admin/configuration/*')?'sub-menu-opened':''}} d-none">
            ...
            @if(access_checker('transaction_management'))
                <li class="nav-category d-none" title="{{translate('transaction_management')}}">
            ...
            @if(access_checker('report_management'))
                ...
                <li class="has-sub-item {{request()->is('admin/report/*')?'sub-menu-opened':''}}">
                    ...
                    <ul class="nav sub-menu ">
                        ...
                        <!-- <li>
                            <a href="{{route('admin.report.service_reported')}}"
                               class="{{request()->is('admin/report/service_reported')?'active-menu':''}}">
                                {{translate('Service Reported')}}
                            </a>
                        </li> -->
                        <li class="d-none">
                ...
                <li class="has-sub-item {{request()->is('admin/analytics/*')?'sub-menu-opened':''}} d-none">
