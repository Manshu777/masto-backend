...
class ProviderController extends Controller
{
    ...
    {
        $bank_details = $this->bankDetail->where('provider_id', $request->user()->id)->first();
    ...
    // Set avalability
    public function update_availability(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            'date' => 'required',
            'time' => 'required',
