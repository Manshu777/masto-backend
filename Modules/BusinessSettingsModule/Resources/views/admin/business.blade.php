                                        ...
                                        <form action="javascript:void(0)" method="POST" id="business-info-update-form">
                                            ...
                                            <div class="discount-type">
                                                                ...
                                                                <div class="mb-30 d-flex flex-column align-items-center gap-2">
                                                                    ...
                                                                    <div class="upload-file mb-30">
                                                                        ...
                                                                        <div class="upload-file__img">
                                                                            <img onerror="this.src='{{asset('assets/admin-module/img/media/upload-file.png')}}'" src="{{asset('storage/app/public/business')}}/{{$data_values->where('key_name','business_favicon')->first()->live_values}}"
                                                                                alt="">
                                                                        </div>
                                                                ...
                                                                <div class="mb-30 d-flex flex-column align-items-center gap-2">
                                                                    ...
                                                                    <div class="upload-file mb-30 max-w-100">
                                                                        ...
                                                                        <div class="upload-file__img upload-file__img_banner ratio-none">
                                                                            <img onerror="this.src='{{asset('assets/admin-module/img/media/banner-upload-file.png')}}'"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12 mb-30 d-none">
                                                    ...
                                                    <!-- lity for chatting -->
                                                    <div class="col-md-6 col-12 mb-30 gap-3 d-none">
